...
namespace CSHowDoISamples
{
    public class DrawAPointUsingABitmap : UserControl
    {
        ...
        private void DrawAPointUsingABitmap_Load(object sender, EventArgs e)
        {
            ...
            bitmapLayer.ZoomLevelSet.ZoomLevel01.DefaultPointStyle.Image = new GeoImage(Samples.RootDirectory + @"Data\United States.png");
            bitmapLayer.ZoomLevelSet.ZoomLevel01.ApplyUntilZoomLevel = ApplyUntilZoomLevel.Level20;
            bitmapLayer.InternalFeatures.Add("Crossing", new Feature(new PointShape(-10606588, 4715285)));
