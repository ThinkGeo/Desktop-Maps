...
namespace CSHowDoISamples
{
    public class UseGeographicAndStandardColors : UserControl
    {
        ...
        private void geographyColorComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            winformsMap1.FindFeatureLayer("WorldLayer").ZoomLevelSet.ZoomLevel01.DefaultAreaStyle.FillSolidBrush.Color = new GeoColor(100, areaColor);
        ...
        private GeoColor GetGeographyColor()
        {
            ...
            switch (color)
            {
                case "Dirt": return GeoColor.GeographicColors.Dirt;
                case "Sand": return GeoColor.GeographicColors.Sand;
                case "Swamp": return GeoColor.GeographicColors.Swamp;
                default: return GeoColor.GeographicColors.Sand;
            }
        }
        ...
        private GeoColor GetStandardColor()
        {
            ...
            switch (color)
            {
                case "Blue": return GeoColor.StandardColors.Blue;
                case "Pink": return GeoColor.StandardColors.Pink;
                case "Teal": return GeoColor.StandardColors.Teal;
                case "Plum": return GeoColor.StandardColors.Plum;
                default: return GeoColor.StandardColors.Gray;
            }
        }
