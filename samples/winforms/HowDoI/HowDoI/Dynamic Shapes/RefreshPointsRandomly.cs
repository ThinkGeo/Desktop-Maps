...
namespace CSHowDoISamples
{
    ...
    {
        private readonly RectangleShape pointsBoundary = new RectangleShape(-20037508, 20037508, 20037508, -20037508);
        ...
        private void UserControl_Load(object sender, EventArgs e)
        {
            ...
            winformsMap1.CurrentExtent = new RectangleShape(-10018754, 20037508, 10018754, -20037508);
