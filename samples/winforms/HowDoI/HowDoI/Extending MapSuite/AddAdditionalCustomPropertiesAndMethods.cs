...
namespace CSHowDoISamples
{
    public class AddAdditionalCustomPropertiesAndMethods : UserControl
    {
        ...
        private void AddAdditionalCustomPropertiesAndMethods_Load(object sender, EventArgs e)
        {
            ...
            AdministrationShapeFileLayer worldLayer = new AdministrationShapeFileLayer(Samples.RootDirectory + @"Data\Countries02.shp", SecurityLevel.AverageUsageLevel1);
            worldLayer.ZoomLevelSet.ZoomLevel01.ApplyUntilZoomLevel = ApplyUntilZoomLevel.Level20;
            worldLayer.ZoomLevelSet.ZoomLevel01.DefaultAreaStyle = AreaStyles.Country1;

            AdministrationShapeFileLayer statesLayer = new AdministrationShapeFileLayer(Samples.RootDirectory + @"Data\USStates.shp", SecurityLevel.AverageUsageLevel2);
