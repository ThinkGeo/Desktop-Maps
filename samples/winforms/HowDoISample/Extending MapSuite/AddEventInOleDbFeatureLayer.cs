...
namespace ThinkGeo.UI.WinForms.HowDoI
{
    public class AddEventInOleDbFeatureLayer : UserControl
    {
        ...
        private void AddEventInOleDbFeatureLayer_Load(object sender, EventArgs e)
        {
            ...
            winformsMap1.CurrentExtent = MapUtil.GetDrawingExtent(new RectangleShape(-97.7612400054933, 30.2895641326905, -97.729482650757, 30.2669048309327), winformsMap1.Width, winformsMap1.Height);
            winformsMap1.BackgroundOverlay.BackgroundBrush = new GeoSolidBrush(GeoColor.FromArgb(255, 233, 232, 214));

            string connectString = string.Format(CultureInfo.InvariantCulture, "Provider=Microsoft.Jet.OLEDB.4.0; Data Source='{0}'", SampleHelper.Get("Austinstreets.mdb"));
            ...
            oleDbFeatureLayer.ZoomLevelSet.ZoomLevel01.CustomStyles.Add(LineStyle.CreateSimpleLineStyle(GeoColors.White, 8F, GeoColors.DarkGray, 10F, true));
