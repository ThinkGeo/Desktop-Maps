...
namespace ThinkGeo.UI.WinForms.HowDoI
{
    public partial class DisplayThinkGeoCloudOfflineMaps : UserControl
    {
        ...
        private void Form_Load(object sender, EventArgs e)
        {
            ...
            ThinkGeoMBTilesLayer thinkGeoMBTilesFeatureLayer = new ThinkGeoMBTilesLayer(SampleHelper.Get("NewYorkCity.mbtiles"), new Uri(SampleHelper.Get("thinkgeo-world-streets-light.json")));
        ...
        private void radioButton_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                thinkGeoMBTilesFeatureLayer.StyleJsonUri = new Uri(SampleHelper.Get("thinkgeo-world-streets-light.json"));
            }
            else if (radioButtonDark.Checked)
            {
                thinkGeoMBTilesFeatureLayer.StyleJsonUri = new Uri(SampleHelper.Get("thinkgeo-world-streets-dark.json"));
            }
            else if (radioButtonCobalt.Checked)
            {
                thinkGeoMBTilesFeatureLayer.StyleJsonUri = new Uri(SampleHelper.Get("thinkgeo-world-streets-cobalt.json"));
            }
