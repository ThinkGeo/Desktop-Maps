...
{
    public class DisplayAzureMapsOverlaySample : UserControl
    {
        ...
        private void AzureMapsAccountLink_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            Process.Start(new ProcessStartInfo("https://portal.azure.com/#browse/Microsoft.Maps%2Faccounts") { UseShellExecute = true });
        }

        private async void displayAzureMaps_Click(object sender, EventArgs e)
        {
            var azureMapsOverlay = new AzureMapsRasterOverlay(bingApplicationId.Text, AzureMapsRasterTileSet.Imagery);
        ...
        private void InitializeComponent()
        {
            ...
            this.displayBingMaps.Click += new System.EventHandler(this.displayAzureMaps_Click);
            // 
            // label2
            // 
            ...
            this.BingMapsAccountLink.LinkClicked += new System.Windows.Forms.LinkLabelLinkClickedEventHandler(this.AzureMapsAccountLink_LinkClicked);
            // 
            // label1
            // 
