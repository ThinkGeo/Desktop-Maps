...
{
    public class FindIntersectingFeatures : UserControl
    {
        public FindIntersectingFeatures()
        {
            InitializeComponent();
        ...
        private async void Form_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                mapView.CenterPoint = new PointShape(-10777924, 3914325);
                mapView.CurrentScale = 11220;
        ...
        private async Task HighlightQueriedFeaturesAsync(IEnumerable<Feature> features)
        {
            ...
            numberOfFeaturesFoundTextBox.Text = $@"Number of features intersecting the drawn shape: {features.Count()}";
        }
        ...
        private void InitializeComponent()
        {
            ...
            mapView.Size = new System.Drawing.Size(1217, 660);
            ...
            consolePanel.Location = new System.Drawing.Point(907, 10);
            consolePanel.Name = "consolePanel";
            consolePanel.Size = new System.Drawing.Size(300, 398);
            ...
            queryLabel.Text = "Perform an 'Intersects' Query";
            ...
            clickLabel.Name = "labclickLabelel2";
            ...
            Name = "FindIntersectingFeatures";
            Size = new System.Drawing.Size(1217, 660);
            Load += Form_Load;
