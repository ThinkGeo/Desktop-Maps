...
{
    public class FindDisjointFeatures : UserControl
    {
        ...
        private async Task HighlightQueriedFeaturesAsync(IEnumerable<Feature> features)
        {
            ...
            numberOfFeaturesFoundTextBox.Text = $@"Number of features disjoint from the drawn shape: {features.Count()}";
        }
        ...
        private void InitializeComponent()
        {
            ...
            mapView.Size = new System.Drawing.Size(1191, 576);
            ...
            consolePanel.Location = new System.Drawing.Point(881, 10);
            ...
            queryLabel.Text = "Perform a 'Disjoint' Query";
            ...
            // 
            // FindDisjointFeatures
            // 
            Controls.Add(consolePanel);
            Controls.Add(mapView);
            Name = "FindDisjointFeatures";
            Size = new System.Drawing.Size(1191, 576);
            Load += Form_Load;
