...
{
    public class FindFeaturesWithinAFeature : UserControl
    {
        ...
        private async Task HighlightQueriedFeaturesAsync(IEnumerable<Feature> features)
        {
            ...
            numberOfFeaturesFoundTextBox.Text = $@"Number of features within the drawn shape: {features.Count()}";
        }
        ...
        private void InitializeComponent()
        {
            ...
            mapView.Size = new System.Drawing.Size(946, 574);
            mapView.TabIndex = 0;
            ...
            consolePanel.Location = new System.Drawing.Point(635, 10);
            ...
            queryLabel.Text = "Perform a 'Within' Query";
            // 
            // clickLabel
            // 
            ...
            // 
            // FindFeaturesWithinAFeature
            // 
            Controls.Add(consolePanel);
            Controls.Add(mapView);
            Name = "FindFeaturesWithinAFeature";
            Size = new System.Drawing.Size(946, 574);
            Load += Form_Load;
