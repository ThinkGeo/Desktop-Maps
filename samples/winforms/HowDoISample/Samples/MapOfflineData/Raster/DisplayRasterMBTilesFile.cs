...
{
    /// <summary>
    /// Logic for DisplayRasterMBTilesFile WinForms sample
    /// </summary>
    public partial class DisplayRasterMBTilesFile : UserControl
    {
        ...
        private void RenderBeyondMaxZoomCheckBox_CheckedChanged(object sender, EventArgs e)
        {
            ...
            rasterMbTilesLayer.RenderBeyondMaxZoom = checkBox.Checked;
            _ = mapView.RefreshAsync();
        }
