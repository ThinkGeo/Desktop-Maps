...
namespace ThinkGeo.UI.WinForms.HowDoI
{
    public class ChangeTheWidthOrColorOfALine : UserControl
    {
        ...
        private void ChangeTheWidthOrColorOfALine_Load(object sender, EventArgs e)
        {
            ...
            ShapeFileFeatureLayer streetsLayer = new ShapeFileFeatureLayer(SampleHelper.Get("austinstreets.shp"));
            streetsLayer.ZoomLevelSet.ZoomLevel01.DefaultLineStyle.OuterPen = new GeoPen(GeoColors.Gray, 5);
        ...
        {
            FeatureLayer streetsLayer = winformsMap1.FindFeatureLayer("StreetsLayer");
            streetsLayer.ZoomLevelSet.ZoomLevel01.DefaultLineStyle.OuterPen.Color = GeoColors.SteelBlue;
        ...
        {
            FeatureLayer streetsLayer = winformsMap1.FindFeatureLayer("StreetsLayer");
            streetsLayer.ZoomLevelSet.ZoomLevel01.DefaultLineStyle.OuterPen.Color = GeoColors.YellowGreen;
