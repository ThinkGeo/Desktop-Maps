...
namespace ThinkGeo.UI.WinForms.HowDoI
{
    public partial class ConvertWorldCoordinatesToScreenCoordinates : UserControl
    {
        ...
        {
            ScreenPointF screenPoint = MapUtil.ToScreenCoordinate(winformsMap1.CurrentExtent, new PointShape(Double.Parse(longitudeTextBox.Text, CultureInfo.InvariantCulture), Double.Parse(latitudeTextBox.Text, CultureInfo.InvariantCulture)), 740, 528);
