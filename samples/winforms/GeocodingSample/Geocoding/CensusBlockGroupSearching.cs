...
namespace Geocoding
{
    public partial class CensusBlockGroupSearching : UserControl
    {
        public CensusBlockGroupSearching()
        {
            InitializeComponent();
        ...
        private void CensusBlockGroupSearching_Load(object sender, EventArgs e)
        {
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            UsaGeocoder geocoder = new UsaGeocoder(dataPath);
        ...
        private void PopulateAddressResultList(Collection<GeocoderMatch> matchResult)
        {
            ...
            {
                if (matchItem.NameValuePairs.ContainsKey("ID_BlkGrp"))
                {
                    lstResult.Items.Add(new ListItem(matchItem, new string[] { "ID_BlkGrp", "State", "County", "TractCE" }));
                }
            }
