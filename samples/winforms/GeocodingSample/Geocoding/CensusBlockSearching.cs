...
namespace Geocoding
{
    public partial class CensusBlockSearching : UserControl
    {
        public CensusBlockSearching()
        {
            InitializeComponent();
        ...
        private void CensusBlockSearching_Load(object sender, EventArgs e)
        {
        ...
        private void PopulateAddressResultList(Collection<GeocoderMatch> matchResult)
        {
            ...
            {
                if (matchItem.NameValuePairs.ContainsKey("ID_Block"))
                {
                    lstResult.Items.Add(new ListItem(matchItem, new string[] { "ID_Block", "State", "County", "TractCE" }));
                }
            }
