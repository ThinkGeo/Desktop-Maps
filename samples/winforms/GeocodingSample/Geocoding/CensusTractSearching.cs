...
namespace Geocoding
{
    public partial class CensusTractSearching : UserControl
    {
        public CensusTractSearching()
        {
            InitializeComponent();
        ...
        private void CensusTractSearching_Load(object sender, EventArgs e)
        {
        ...
        private void PopulateAddressResultList(Collection<GeocoderMatch> matchResult)
        {
            ...
            {
                if (matchItem.NameValuePairs.ContainsKey("ID_Tract"))
                {
                    lstResult.Items.Add(new ListItem(matchItem, new string[] { "ID_Tract", "State", "County" }));
                }
            }
