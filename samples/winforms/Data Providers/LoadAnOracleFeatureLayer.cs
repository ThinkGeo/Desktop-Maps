...
namespace ThinkGeo.UI.WinForms.HowDoI
{
    public class LoadAnOracleFeatureLayer : UserControl
    {
        ...
        private void LoadOracleLayer()
        {
            ...
            oracleLayer.ZoomLevelSet.ZoomLevel01.DefaultAreaStyle = AreaStyle.CreateSimpleAreaStyle(GeoColor.FromArgb(255, 233, 232, 214), GeoColor.FromArgb(255, 118, 138, 69));
