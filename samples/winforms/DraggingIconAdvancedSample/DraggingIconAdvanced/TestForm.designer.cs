namespace DraggingIconAdvanced
{
    partial class TestForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblDescription.Text = "You can click and drag the icons. You can double left click to add new icon. You " +
    "can double right click on icon to remove it.";
            ...
            this.Text = "Code Community Project-Dragging Icon (Advanced)";
