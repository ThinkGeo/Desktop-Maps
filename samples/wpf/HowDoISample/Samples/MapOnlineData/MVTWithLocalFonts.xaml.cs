...
namespace ThinkGeo.UI.Wpf.HowDoI
{
    ...
    public partial class MVTWithLocalFonts : IDisposable
    {
        ...
        private FontsLoader fontsLoader = new FontsLoader(FontsFolder);
    ...
    public class FontsLoader
{
    ...
    public FontsLoader(string fontsFolder)
    {
    ...
    public string DetectLanguageTag(string text)
    {
    ...
    public string GetNotoFilePath(string languageTag, GeoFont font)
    {
        ...
        if (hasItalic)
        {
            if (wantBold && wantItalic)
            {
                ...
                filename = FontExists(_fontsfolder, boldItalicFilename)
                    ? boldItalicFilename
                    : $"{family}-Regular.ttf";
            }
            else if (wantBold)
            {
                ...
                filename = FontExists(_fontsfolder, boldFilename)
                    ? boldFilename
                    : $"{family}-Regular.ttf";
            }
            else if (wantItalic)
            {
                ...
                filename = FontExists(_fontsfolder, italicFilename)
                    ? italicFilename
                    : $"{family}-Regular.ttf";
            }
            else
        ...
        return Path.Combine(_fontsfolder, filename);
    }
