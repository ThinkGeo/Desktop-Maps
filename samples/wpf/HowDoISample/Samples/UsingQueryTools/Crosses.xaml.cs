...
{
    /// <summary>
    /// Interaction logic for Crosses.xaml
    /// </summary>
    public partial class Crosses : UserControl
    {
        ...
        private Collection<Feature> PerformSpatialQuery(BaseShape shape, FeatureLayer layer)
        {
            ...
            layer.Open();
            var features = layer.FeatureSource.SpatialQuery(shape, QueryType.Crosses, ReturningColumnsType.AllColumns);
            layer.Close();
