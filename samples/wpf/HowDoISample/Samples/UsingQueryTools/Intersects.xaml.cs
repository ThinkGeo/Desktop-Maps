...
{
    /// <summary>
    /// Interaction logic for Intersects.xaml
    /// </summary>
    public partial class Intersects : UserControl
    {
        ...
        private Collection<Feature> PerformSpatialQuery(BaseShape shape, FeatureLayer layer)
        {
            ...
            layer.Open();
            var features = layer.FeatureSource.SpatialQuery(shape, QueryType.Intersects, ReturningColumnsType.AllColumns);
            layer.Close();
