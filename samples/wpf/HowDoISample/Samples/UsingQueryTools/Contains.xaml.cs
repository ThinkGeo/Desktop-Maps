...
namespace ThinkGeo.UI.Wpf.HowDoI.UsingQueryTools
{
    ...
    /// </summary>
    public partial class Contains : UserControl
    {
        public Contains()
        {
            InitializeComponent();
        ...
        private void MapView_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            queryFeatureLayer.ZoomLevelSet.ZoomLevel01.DefaultPointStyle = PointStyle.CreateSimplePointStyle(PointSymbolType.Circle, GeoColors.BrightRed, 15);
