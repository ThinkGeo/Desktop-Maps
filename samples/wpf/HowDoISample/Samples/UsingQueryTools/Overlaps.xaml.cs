...
{
    /// <summary>
    /// Interaction logic for Overlaps.xaml
    /// </summary>
    public partial class Overlaps : UserControl
    {
        ...
        private Collection<Feature> PerformSpatialQuery(BaseShape shape, FeatureLayer layer)
        {
            ...
            layer.Open();
            var features = layer.FeatureSource.SpatialQuery(shape, QueryType.Overlaps, ReturningColumnsType.AllColumns);
            layer.Close();
