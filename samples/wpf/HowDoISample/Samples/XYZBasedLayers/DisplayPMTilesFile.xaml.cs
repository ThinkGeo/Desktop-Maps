...
{
    /// <summary>
    /// Show a vector PMTiles archive (PMTiles v3), styled with a Mapbox style JSON.
    /// </summary>
    public partial class DisplayPmTilesFile : IDisposable
    {
        private bool _initialized;
        private VectorPmTilesAsyncLayer _mvtLayer;

        public DisplayPmTilesFile()
        {
            InitializeComponent();
        }
        ...
        private async void Map_SizeChanged(object sender, SizeChangedEventArgs e)
        {
            ...
            _mvtLayer = new VectorPmTilesAsyncLayer(@".\Data\Pmtiles\frisco.pmtiles");
            _mvtLayer.StyleJsonUri = @".\Data\Pmtiles\style.json";
