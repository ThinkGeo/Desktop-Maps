...
namespace ThinkGeo.UI.Wpf.HowDoI
{
    ...
    /// </summary>
    public partial class ClipShapeSample : UserControl, IDisposable
    {
        ...
        private async void MapView_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            LayerOverlay clipOverlay = new LayerOverlay();
        ...
        private async void ClipShape_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            LayerOverlay clipOverlay = (LayerOverlay)mapView.Overlays["clipOverlay"];
            ...
            InMemoryFeatureLayer clipLayer = (InMemoryFeatureLayer)clipOverlay.Layers["clipLayer"];
