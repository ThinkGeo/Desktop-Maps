...
namespace ThinkGeo.UI.Wpf.HowDoI
{
    ...
    /// </summary>
    public partial class ClipShapeSample : UserControl
    {
        private readonly ShapeFileFeatureLayer cityLimits = new ShapeFileFeatureLayer(@"../../../Data/Shapefile/FriscoCityLimits.shp");
        private readonly InMemoryFeatureLayer westRegionLayer = new InMemoryFeatureLayer();
        private readonly InMemoryFeatureLayer clipLayer = new InMemoryFeatureLayer();
        ...
        /// <summary>
        /// Setup the map with the ThinkGeo Cloud Maps overlay. Also, add the cityLimits, westRegionLayer and clipLayer
        ...
        private void MapView_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            // Add cityLimits to a LayerOverlay
            layerOverlay.Layers.Add(westRegionLayer);

            // Add clipLayer to the layerOverlay
            layerOverlay.Layers.Add(clipLayer);
        ...
        /// </summary>
        private void ClipShape_OnClick(object sender, RoutedEventArgs e)
        {
