...
namespace ThinkGeo.UI.Wpf.HowDoI
{
    ...
    {
        private readonly InMemoryFeatureLayer railway = new InMemoryFeatureLayer();
        private readonly InMemoryFeatureLayer subLineLayer = new InMemoryFeatureLayer();
        ...
        private void MapView_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            layerOverlay.Layers.Add(railway);

            // Add subLineLayer to the layerOverlay
            layerOverlay.Layers.Add(subLineLayer);
