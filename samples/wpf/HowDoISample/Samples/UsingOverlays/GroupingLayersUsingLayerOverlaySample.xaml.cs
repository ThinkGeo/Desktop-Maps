...
namespace ThinkGeo.UI.Wpf.HowDoI
{
    ...
    {
        private readonly LayerOverlay poiOverlay = new LayerOverlay();
        private readonly LayerOverlay landuseOverlay = new LayerOverlay();
        ...
        private void MapView_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            mapView.Overlays.Add(landuseOverlay);
