...
namespace ThinkGeo.UI.Wpf.HowDoI
{
    ...
    /// </summary>
    public partial class FindIntersectingFeatures : IDisposable
    {
        ...
        private async void MapView_Loaded(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                MapView.CurrentScale = MapUtil.GetScale(MapView.MapUnit, sampleShapeBBox, MapView.MapWidth, MapView.MapHeight) * 1.5; // Multiply the current scale by a factor like 1.5 (50% increase) to zoom out and expand the map extent.
        ...
        private async Task HighlightQueriedFeaturesAsync(IEnumerable<Feature> features)
        {
            ...
            TxtNumberOfFeaturesFound.Text = $"Number of features intersecting the drawn shape: {enumerable.Length}";
        }

        /// <summary>
        /// Perform the spatial query and draw the shapes on the map
        /// </summary>
        private async Task GetFeaturesIntersectsAsync(BaseShape polygon)
        {
