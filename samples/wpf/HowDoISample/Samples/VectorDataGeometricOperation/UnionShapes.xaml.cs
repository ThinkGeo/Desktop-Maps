...
namespace ThinkGeo.UI.Wpf.HowDoI
{
    ...
    public partial class UnionShapes : IDisposable
    {
        ...
        private void Map_SizeChanged(object sender, SizeChangedEventArgs e)
        {
            ...
            dividedCityLimits.ZoomLevelSet.ZoomLevel01.DefaultTextStyle = TextStyle.CreateSimpleTextStyle("NAME", "Noto Sans", 12, DrawingFontStyles.Bold, GeoColors.Black, GeoColors.White, 2);
            ...
            Map.CenterPoint = dividedCityLimitsBBox.GetCenterPoint();
            var MapScale = MapUtil.GetScale(Map.MapUnit, dividedCityLimitsBBox, Map.MapWidth, Map.MapHeight);
