...
{
    /// <summary>
    /// Interaction logic for LoadAWmtsImageWithProjection.xaml
    /// </summary>
    public partial class LoadAWmtsImageWithProjection : UserControl
    {
        private WmtsLayer wmtsLayer;

        public LoadAWmtsImageWithProjection()
        {
            InitializeComponent();
        }
        ...
        private void mapView_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            wmtsLayer.ProjectedTileCache = new FileRasterTileCache("WmtsProjectedTileCache", "USGSImageryOnly-4326");
            wmtsLayer.TileCache = new FileRasterTileCache("WmtsTileCache", "USGSImageryOnly-3857");
        ...
        private void projectionCkb_Checked(object sender, RoutedEventArgs e)
        {
            ...
            if (wmtsLayer != null)
            {
                ...
                wmtsLayer.ProjectionConverter = new UnmanagedProjectionConverter(3857, srid);
        ...
        private void projectionCkb_Unchecked(object sender, RoutedEventArgs e)
        {
            ...
            if (wmtsLayer != null)
            {
                wmtsLayer.ProjectionConverter.Close();
