...
{
    /// <summary>
    /// NOAA weather stations' current readings, drawn by the renderer.
    /// </summary>
    public partial class NOAAWeatherStations
    {
        ...
        private readonly FeatureSourceVectorTileSource _stations = new FeatureSourceVectorTileSource { MaxConcurrentEncodes = 1 };
        ...
        {
            _stations.FeatureSources.Add("stations", new NoaaWeatherStationFeatureSource
            {
            ...
            style.AddStyle(Editor.Text, _stations);
