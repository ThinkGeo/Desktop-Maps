...
namespace LargeScaleMapPrinting
{
    public partial class Sample : Window
    {
        ...
        private void AddMapLayer()
        {
            ...
            ShapeFileFeatureLayer parcelsLayer = new ShapeFileFeatureLayer(@"..\..\Data\parcels.shp", GeoFileReadWriteMode.Read);
        ...
        private void AddDataGridLayer1()
        {
            ...
            ShapeFileFeatureLayer shapefileFeatureLayer = new ShapeFileFeatureLayer(@"..\..\Data\Parcels.shp", GeoFileReadWriteMode.Read);
