...
namespace ThinkGeo.MapSuite.USDemographicMap
{
    ...
    public abstract class DemographicStyleBuilder
    {
        ...
        public Collection<Styles.Style> GetStyles(FeatureSource featureSource)
        {
            return GetStylesCore(featureSource);
        }

        protected abstract Collection<Styles.Style> GetStylesCore(FeatureSource featureSource);
    }
}