...
|---|
|[`MapTool()`](#maptool)|
|[`MapTool(Boolean)`](#maptoolboolean)|
...
|[`Content`](#content)|`Object`|This property gets or sets the content of this map tool. It's a DependencyProperty.|
|[`ContextMenu`](#contextmenu)|`ContextMenu`|N/A|
|[`CurrentMap`](#currentmap)|[`MapView`](ThinkGeo.UI.Wpf.MapView.md)|Gets or sets current map that the mapTool will be drawn on|
...
|Name|Type|Description|
|---|---|---|
|newValue|`Boolean`|Indicates whether the visibility of MapTool is set as Visibility.Visible|
