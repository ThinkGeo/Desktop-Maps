...
|Name|
|---|
|[`OpenStreetMapOverlay()`](#openstreetmapoverlay)|
|[`OpenStreetMapOverlay(String)`](#openstreetmapoverlaystring)|
|[`OpenStreetMapOverlay(IWebProxy)`](#openstreetmapoverlayiwebproxy)|
|[`OpenStreetMapOverlay(String,IWebProxy)`](#openstreetmapoverlaystringiwebproxy)|
...
|[`WebProxy`](#webproxy)|`IWebProxy`|Gets or sets the WebProxy for using OpenStreet map service.|
...
**Summary**
   ...
   *This method overrides from its base class TileOverlay. It actually requests image for the passed tile with the passed world extent.*
...
|tile|[`TileView`](ThinkGeo.UI.Wpf.TileView.md)|A tile object that creating by the GetTileCore method. It's the tile which needs to be draw in this mehtod.|
...
|Type|Description|
|---|---|
|[`TileView`](ThinkGeo.UI.Wpf.TileView.md)|A concrete TileView object that for requesting images from OpenStreet serverice.|
