...
|[`PopupOverlay(IEnumerable<Popup>)`](#popupoverlayienumerable<popup>)|
...
|[`Popups`](#popups)|GeoCollection<[`Popup`](ThinkGeo.UI.Wpf.Popup.md)>|This property gets a collection of popup that are added into this overlay.|
...
GeoCollection<[`Popup`](ThinkGeo.UI.Wpf.Popup.md)>
...
|Name|Type|Description|
|---|---|---|
|targetExtent|[`RectangleShape`](../ThinkGeo.Core/ThinkGeo.Core.RectangleShape.md)|This parameter indicates an extent to draw the popups.|
|overlayRefreshType|[`OverlayRefreshType`](ThinkGeo.UI.Wpf.OverlayRefreshType.md)|This parameter indicates whether this overlay needs to be refresh or not.|
...
|Type|Description|
|---|---|
|[`RectangleShape`](../ThinkGeo.Core/ThinkGeo.Core.RectangleShape.md)|A RectangleShape value that to hold all popups.|
