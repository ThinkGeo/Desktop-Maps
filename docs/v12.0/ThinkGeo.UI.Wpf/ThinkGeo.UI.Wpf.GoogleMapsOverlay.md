...
|[`GoogleMapsOverlay(String,String,IWebProxy)`](#googlemapsoverlaystringstringiwebproxy)|
...
|---|---|---|
|[`ApiKey`](#apikey)|`String`|N/A|
|[`Attribution`](#attribution)|`String`|N/A|
|[`AutoRefreshInterval`](#autorefreshinterval)|`TimeSpan`|N/A|
|[`CanRefreshRegion`](#canrefreshregion)|`Boolean`|N/A|
|[`ClientId`](#clientid)|`String`|This property gets and sets the clientId for the GoogleMapsOverlay.|
...
|[`MapType`](#maptype)|[`GoogleMapsMapType`](../ThinkGeo.Core/ThinkGeo.Core.GoogleMapsMapType.md)|Gets or sets the map types available from Google Maps.|
...
|[`PrivateKey`](#privatekey)|`String`|This property gets and sets the privateKey for the GoogleMapsOverlay.|
...
|[`UriSigningSecret`](#urisigningsecret)|`String`|N/A|
...
|Type|Description|
|---|---|
|[`RectangleShape`](../ThinkGeo.Core/ThinkGeo.Core.RectangleShape.md)|Returns a RectangleShape indicating the extent of the Google world map.|
