...
|Name|Type|Description|
|---|---|---|
|targetExtent|[`RectangleShape`](../ThinkGeo.Core/ThinkGeo.Core.RectangleShape.md)|This parameter indicates the extent that to place the popup.|
|drawingScreenWidth|`Double`|This parameter indicates the screen width of the map.|
|drawingScreenHeight|`Double`|This parameter indicates the screen height of the map.|
...
---
#### `OnArrowHeightChanged(DependencyPropertyChangedEventArgs)`

**Summary**

   *Raises the  event when the ArrowHeight property is changed.*
...
|Name|Type|Description|
|---|---|---|
|args|`DependencyPropertyChangedEventArgs`|The  instance containing the event data.|
...
|Name|Type|Description|
|---|---|---|
|eventArgs|`DependencyPropertyChangedEventArgs`|N/A|
