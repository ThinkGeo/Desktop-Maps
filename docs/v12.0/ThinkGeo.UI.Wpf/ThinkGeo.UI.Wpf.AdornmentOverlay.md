...
|Name|
|---|
|[`AdornmentOverlay()`](#adornmentoverlay)|
...
|[`Layers`](#layers)|GeoCollection<[`AdornmentLayer`](../ThinkGeo.Core/ThinkGeo.Core.AdornmentLayer.md)>|This property gets a collection of the AdornmentLayers that are added to the AdornmentOverlay.|
...
|Name|Type|Description|
|---|---|---|
|targetExtent|[`RectangleShape`](../ThinkGeo.Core/ThinkGeo.Core.RectangleShape.md)|This parameter specifies the extent for drawing this overlay.|
|overlayRefreshType|[`OverlayRefreshType`](ThinkGeo.UI.Wpf.OverlayRefreshType.md)|This parameter specifies whether this overlay need to be clear and refresh or not.|
