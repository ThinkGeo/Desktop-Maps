...
|[`BackgroundBrush`](#backgroundbrush)|[`GeoBrush`](../ThinkGeo.Core/ThinkGeo.Core.GeoBrush.md)|Gets or sets the background brush for the MapControl.|
...
|refreshType|[`OverlayRefreshType`](ThinkGeo.UI.Wpf.OverlayRefreshType.md)|This parameter specifies whether this overlay need to be clear and refresh or not.|
