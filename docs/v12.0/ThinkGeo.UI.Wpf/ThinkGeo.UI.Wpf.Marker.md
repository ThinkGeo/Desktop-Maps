...
|---|
|[`Marker()`](#marker)|
|[`Marker(Double,Double)`](#markerdoubledouble)|
|[`Marker(PointShape)`](#markerpointshape)|
...
|[`ImageSource`](#imagesource)|`ImageSource`|Image source of marker. It's a wrapper of the ImageSourceProperty.|
...
|[`Position`](#position)|`Point`|World Position of marker. It's a wrapper of the PositionProperty.|
...
|[`RotateAngle`](#rotateangle)|`Single`|N/A|
...
|[`XOffset`](#xoffset)|`Double`|Gets and sets screen offset x of marker image.|
|[`YOffset`](#yoffset)|`Double`|Gets and sets screen offset y of marker image.|
...
|[`RaiseOnPositionChanged(PointShape,PointShape)`](#raiseonpositionchangedpointshapepointshape)|
...
|---|---|---|
|[`PositionChanged`](#positionchanged)|[`PositionChangedMarkerEventArgs`](ThinkGeo.UI.Wpf.PositionChangedMarkerEventArgs.md)|N/A|
...
|Name|Type|Description|
|---|---|---|
|targetExtent|[`RectangleShape`](../ThinkGeo.Core/ThinkGeo.Core.RectangleShape.md)|A world extent that the marker is placed on the map.|
|drawingScreenWidth|`Double`|Current map screen width.|
|drawingScreenHeight|`Double`|Current map screen height.|
...
|Name|Type|Description|
|---|---|---|
|state|`Byte[]`|A byte array that holds current marker state. It's created by the SaveState method of this class.|
...
|Type|Description|
|---|---|
|`Byte[]`|A byte array that holds current marker state. It can be used for restoring the marker state by creating a new marker and calling marker.LoadState(byte[]) method|
...
|Type|Description|
|---|---|
|`Size`|New size of marker after measuring.|

**Parameters**

|Name|Type|Description|
|---|---|---|
|constraint|`Size`|Constraint size of marker|
...
|Name|Type|Description|
|---|---|---|
|oldContent|`Object`|N/A|
|newContent|`Object`|N/A|
...
|Name|Type|Description|
|---|---|---|
|oldContentStringFormat|`String`|N/A|
|newContentStringFormat|`String`|N/A|
...
|Name|Type|Description|
|---|---|---|
|oldContentTemplate|`DataTemplate`|N/A|
|newContentTemplate|`DataTemplate`|N/A|
...
|Name|Type|Description|
|---|---|---|
|oldContentTemplateSelector|`DataTemplateSelector`|N/A|
|newContentTemplateSelector|`DataTemplateSelector`|N/A|
...
|Name|Type|Description|
|---|---|---|
|eventArgs|`DependencyPropertyChangedEventArgs`|Maintains arguments for PositionChanged event.|
...
|---|---|---|
|item|`Object`|N/A|
|itemTemplate|`DataTemplate`|N/A|
|itemTemplateSelector|`DataTemplateSelector`|N/A|
|itemStringFormat|`String`|N/A|
...
---
#### `RaiseOnPositionChanged(PointShape,PointShape)`
...
|Name|Type|Description|
|---|---|---|
|newPosition|[`PointShape`](../ThinkGeo.Core/ThinkGeo.Core.PointShape.md)|N/A|
|oldPosition|[`PointShape`](../ThinkGeo.Core/ThinkGeo.Core.PointShape.md)|N/A|
...
[`PositionChangedMarkerEventArgs`](ThinkGeo.UI.Wpf.PositionChangedMarkerEventArgs.md)
