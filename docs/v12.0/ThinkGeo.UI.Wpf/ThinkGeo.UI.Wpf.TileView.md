...
**Remarks**
   ...
   *When implementing this abstract method, consider if the IsAsync property. If yes, draw it in background thread; If no, draw it directly with the properties we provid.*
...
|---|---|---|
|geoCanvas|[`GeoCanvas`](../ThinkGeo.Core/ThinkGeo.Core.GeoCanvas.md)|This parameter is the canvas object to draw on.|
|exception|`Exception`|This parameter is the real exception in during drawing process.|
...
|Name|Type|Description|
|---|---|---|
|canvas|[`GeoCanvas`](../ThinkGeo.Core/ThinkGeo.Core.GeoCanvas.md)|This parameter is the canvas object to draw on.|
|exception|`Exception`|This parameter is the real exception in during drawing process.|
...
|Name|Type|Description|
|---|---|---|
|args|[`DrawingTileViewEventArgs`](ThinkGeo.UI.Wpf.DrawingTileViewEventArgs.md)|An event argument for the Drawing event in TileView class.|
...
|Name|Type|Description|
|---|---|---|
|args|[`DrawnTileViewEventArgs`](ThinkGeo.UI.Wpf.DrawnTileViewEventArgs.md)|An event argument for the Drawn event in the TileView class.|
...
|Name|Type|Description|
|---|---|---|
|args|`EventArgs`|This parameter maitains the arguments for the Opened event.|
