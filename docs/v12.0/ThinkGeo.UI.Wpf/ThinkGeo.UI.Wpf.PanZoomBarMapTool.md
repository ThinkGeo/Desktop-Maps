...
|Name|
|---|
|[`PanZoomBarMapTool()`](#panzoombarmaptool)|
...
|[`DisplayZoomBarText`](#displayzoombartext)|[`ZoomBarTextDisplayMode`](ThinkGeo.UI.Wpf.ZoomBarTextDisplayMode.md)|Gets and sets whether the track level feature is enabled.|
...
|[`GlobeButtonImageSource`](#globebuttonimagesource)|`BitmapSource`|Gets or sets the image source for the globe button.|
|[`GlobeButtonVisibility`](#globebuttonvisibility)|`Visibility`|This property gets|
...
|[`OnGlobeButtonClick(RectangleShape)`](#onglobebuttonclickrectangleshape)|
...
|---|---|---|
|[`GlobeButtonClick`](#globebuttonclick)|[`GlobeButtonClickPanZoomBarMapToolEventArgs`](ThinkGeo.UI.Wpf.GlobeButtonClickPanZoomBarMapToolEventArgs.md)|N/A|
...
**Remarks**
   ...
   *If it's none, a small zoom level tip won't appear when dragging the zoom bar up and down. The default value is None.*

**Return Value**

[`ZoomBarTextDisplayMode`](ThinkGeo.UI.Wpf.ZoomBarTextDisplayMode.md)
...
---
#### `GlobeButtonImageSource`

**Summary**

   *Gets or sets the image source for the globe button.*
...
|Name|Type|Description|
|---|---|---|
|mapView|[`MapView`](ThinkGeo.UI.Wpf.MapView.md)|N/A|
...
|Name|Type|Description|
|---|---|---|
|newValue|`Boolean`|Whether the tool is enabled or not.|
...
|Name|Type|Description|
|---|---|---|
|wpfMap|[`MapView`](ThinkGeo.UI.Wpf.MapView.md)|N/A|
...
**Summary**
   ...
   *Called when clicking globe button.*
...
|Name|Type|Description|
|---|---|---|
|newExtent|[`RectangleShape`](../ThinkGeo.Core/ThinkGeo.Core.RectangleShape.md)|The new extent.|
...
[`GlobeButtonClickPanZoomBarMapToolEventArgs`](ThinkGeo.UI.Wpf.GlobeButtonClickPanZoomBarMapToolEventArgs.md)
