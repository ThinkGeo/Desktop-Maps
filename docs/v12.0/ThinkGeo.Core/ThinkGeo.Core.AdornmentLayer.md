...
+ `Object`
  + [`Layer`](../ThinkGeo.Core/ThinkGeo.Core.Layer.md)
    + **`AdornmentLayer`**
      + [`LegendAdornmentLayer`](../ThinkGeo.Core/ThinkGeo.Core.LegendAdornmentLayer.md)
      + [`LogoAdornmentLayer`](../ThinkGeo.Core/ThinkGeo.Core.LogoAdornmentLayer.md)
      + [`MagneticDeclinationAdornmentLayer`](../ThinkGeo.Core/ThinkGeo.Core.MagneticDeclinationAdornmentLayer.md)
      + [`ScaleBarAdornmentLayer`](../ThinkGeo.Core/ThinkGeo.Core.ScaleBarAdornmentLayer.md)
      + [`ScaleLineAdornmentLayer`](../ThinkGeo.Core/ThinkGeo.Core.ScaleLineAdornmentLayer.md)
      + [`ScaleTextAdornmentLayer`](../ThinkGeo.Core/ThinkGeo.Core.ScaleTextAdornmentLayer.md)
...
|[`Location`](#location)|[`AdornmentLocation`](../ThinkGeo.Core/ThinkGeo.Core.AdornmentLocation.md)|This property gets and sets the drawing location of the AdornmentLayer.|
...
|[`XOffsetInPixel`](#xoffsetinpixel)|`Single`|This property gets and sets the X pixel offset for the AdornmentLayer.|
|[`YOffsetInPixel`](#yoffsetinpixel)|`Single`|This property gets and sets the Y pixel offset for the AdornmentLayer.|
...
|Type|Description|
|---|---|
|[`ScreenPointF`](../ThinkGeo.Core/ThinkGeo.Core.ScreenPointF.md)|It returns the upper left screen point of where the AdornmentLayer will be drawn.|

**Parameters**

|Name|Type|Description|
|---|---|---|
|canvas|[`GeoCanvas`](../ThinkGeo.Core/ThinkGeo.Core.GeoCanvas.md)|This parameter is the view used in drawing.|
|adornmentWidth|`Single`|This parameter is the width of the adornment.|
|adornmentHeight|`Single`|This parameter is the height of the adornment|
...
**Remarks**
   ...
   *This virtual method is called from the concrete public method Draw. This method draws the representation of the layer based on the extent you provided. You can use the full power of the GeoCanvas to do the drawing.*
