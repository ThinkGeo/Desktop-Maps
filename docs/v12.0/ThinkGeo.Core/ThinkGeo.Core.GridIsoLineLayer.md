...
|Name|
|---|
|[`GridIsoLineLayer()`](#gridisolinelayer)|
|[`GridIsoLineLayer(String)`](#gridisolinelayerstring)|
|[`GridIsoLineLayer(String,IEnumerable<Double>)`](#gridisolinelayerstringienumerable<double>)|
|[`GridIsoLineLayer(String,IEnumerable<Double>,Double,Double)`](#gridisolinelayerstringienumerable<double>doubledouble)|
|[`GridIsoLineLayer(String,IEnumerable<Double>,Double,Double,IsoLineType)`](#gridisolinelayerstringienumerable<double>doubledoubleisolinetype)|
...
|[`GridPathFilename`](#gridpathfilename)|`String`|N/A|
