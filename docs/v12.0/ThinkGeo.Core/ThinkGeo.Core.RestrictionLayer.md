...
|[`RestrictionLayer(IEnumerable<AreaBaseShape>)`](#restrictionlayerienumerable<areabaseshape>)|
|[`RestrictionLayer(IEnumerable<AreaBaseShape>,RestrictionMode)`](#restrictionlayerienumerable<areabaseshape>restrictionmode)|
|[`RestrictionLayer(IEnumerable<AreaBaseShape>,RestrictionMode,Double,Double)`](#restrictionlayerienumerable<areabaseshape>restrictionmodedoubledouble)|
...
|[`CustomStyles`](#customstyles)|GeoCollection<[`Style`](../ThinkGeo.Core/ThinkGeo.Core.Style.md)>|Allows you to add custom styles to decorate restriction zones.  In this case, you must set RestrictionStyle to UseCustomStyles as well.|
...
|[`LowerScale`](#lowerscale)|`Double`|Specifies the lower threshold of the layer.|
...
|[`RestrictionMode`](#restrictionmode)|[`RestrictionMode`](../ThinkGeo.Core/ThinkGeo.Core.RestrictionMode.md)|Specifies whether you want to show or hide zones.|
|[`RestrictionStyle`](#restrictionstyle)|[`RestrictionStyle`](../ThinkGeo.Core/ThinkGeo.Core.RestrictionStyle.md)|Specifies the display style of the restriction zones.|
...
|[`UpperScale`](#upperscale)|`Double`|Specifies the upper threshold of the layer.|
|[`Zones`](#zones)|GeoCollection<[`AreaBaseShape`](../ThinkGeo.Core/ThinkGeo.Core.AreaBaseShape.md)>|Specifies the areas you want to restrict.|
...
GeoCollection<[`Style`](../ThinkGeo.Core/ThinkGeo.Core.Style.md)>
...
[`RestrictionMode`](../ThinkGeo.Core/ThinkGeo.Core.RestrictionMode.md)
...
[`RestrictionStyle`](../ThinkGeo.Core/ThinkGeo.Core.RestrictionStyle.md)
...
GeoCollection<[`AreaBaseShape`](../ThinkGeo.Core/ThinkGeo.Core.AreaBaseShape.md)>
...
|Type|Description|
|---|---|
|[`RectangleShape`](../ThinkGeo.Core/ThinkGeo.Core.RectangleShape.md)|This method returns the bounding box of the zones.|
