...
|[`GridFeatureSource(String)`](#gridfeaturesourcestring)|
...
|[`NumberOfColumns`](#numberofcolumns)|`Int32`|Gets column number of the grid.|
|[`NumberOfRows`](#numberofrows)|`Int32`|Gets row number of the grid.|
|[`PathFilename`](#pathfilename)|`String`|This property gets and sets the path and file of the grid file you want to use.|
...
|[`ReplaceNoDataValue(GridCell[,],Double)`](#replacenodatavaluegridcell[]double)|
|[`ReplaceNoDataValue(GridCell[,],Double,GridInterpolationModel)`](#replacenodatavaluegridcell[]doublegridinterpolationmodel)|
...
|---|---|---|
|[`GeneratingGrid`](#generatinggrid)|[`GeneratingGridFeatureSourceEventArgs`](../ThinkGeo.Core/ThinkGeo.Core.GeneratingGridFeatureSourceEventArgs.md)|N/A|
...
|Type|Description|
|---|---|
|[`GridCell[,]`](../ThinkGeo.Core/ThinkGeo.Core.GridCell.md)|N/A|

**Parameters**

|Name|Type|Description|
|---|---|---|
|gridMatrix|[`GridCell[,]`](../ThinkGeo.Core/ThinkGeo.Core.GridCell.md)|N/A|
|noDataValue|`Double`|N/A|
...
|gridMatrix|[`GridCell[,]`](../ThinkGeo.Core/ThinkGeo.Core.GridCell.md)|N/A|
|noDataValue|`Double`|N/A|
|gridInterpolationModel|[`GridInterpolationModel`](../ThinkGeo.Core/ThinkGeo.Core.GridInterpolationModel.md)|N/A|
...
[`GeneratingGridFeatureSourceEventArgs`](../ThinkGeo.Core/ThinkGeo.Core.GeneratingGridFeatureSourceEventArgs.md)
