...
|---|
|[`RingShape()`](#ringshape)|
|[`RingShape(IEnumerable<Vertex>)`](#ringshapeienumerable<vertex>)|
|[`RingShape(String)`](#ringshapestring)|
|[`RingShape(Byte[])`](#ringshapebyte[])|
...
|[`Id`](#id)|`String`|N/A|
|[`Tag`](#tag)|`Object`|N/A|
|[`Vertices`](#vertices)|Collection<[`Vertex`](../ThinkGeo.Core/ThinkGeo.Core.Vertex.md)>|This property is the collection of points that make up the RingShape.|
...
|[`RemoveVertex(Vertex,RingShape)`](#removevertexvertexringshape)|
...
|[`ScaleOneRing(RingShape,Double,Double,Double)`](#scaleoneringringshapedoubledoubledouble)|
...
|Type|Description|
|---|---|
|`Boolean`|Returns true if ring is oriented counter-clockwise.|
...
|Name|Type|Description|
|---|---|---|
|selectedVertex|[`Vertex`](../ThinkGeo.Core/ThinkGeo.Core.Vertex.md)|The selected vertex must be a vertex of ring shape, otherwise it will return false and ring shape will keep the same.|
...
|---|---|---|
|selectedVertex|[`Vertex`](../ThinkGeo.Core/ThinkGeo.Core.Vertex.md)|The selected vertex must be a vertex of ring shape, otherwise it will return false and ring shape will keep the same.|
|ringShape|[`RingShape`](../ThinkGeo.Core/ThinkGeo.Core.RingShape.md)|The line shape will be removed one vertex.|
...
|shapeUnit|[`GeographyUnit`](../ThinkGeo.Core/ThinkGeo.Core.GeographyUnit.md)|The GeographUnit of the targetShape.|
...
|Name|Type|Description|
|---|---|---|
|targetRingShape|[`RingShape`](../ThinkGeo.Core/ThinkGeo.Core.RingShape.md)|N/A|
