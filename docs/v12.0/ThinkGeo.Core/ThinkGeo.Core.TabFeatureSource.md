...
|Name|
|---|
|[`TabFeatureSource()`](#tabfeaturesource)|
|[`TabFeatureSource(String)`](#tabfeaturesourcestring)|
|[`TabFeatureSource(String,FileAccess)`](#tabfeaturesourcestringfileaccess)|
...
|[`TabPathFilename`](#tabpathfilename)|`String`|N/A|
...
|[`CreateTabFile(String,IEnumerable<TabDbfColumn>,IEnumerable<Feature>)`](#createtabfilestringienumerable<tabdbfcolumn>ienumerable<feature>)|
|[`CreateTabFile(String,IEnumerable<TabDbfColumn>,IEnumerable<Feature>,OverwriteMode)`](#createtabfilestringienumerable<tabdbfcolumn>ienumerable<feature>overwritemode)|
|[`CreateTabFile(String,IEnumerable<TabDbfColumn>,IEnumerable<Feature>,OverwriteMode,Encoding)`](#createtabfilestringienumerable<tabdbfcolumn>ienumerable<feature>overwritemodeencoding)|
...
|[`GetCurrentProjInfo()`](#getcurrentprojinfo)|
...
|[`GetTabFeatureStyles()`](#gettabfeaturestyles)|
...
|[`SetCurrentProjInfo(TABProjInfo)`](#setcurrentprojinfotabprojinfo)|
...
|buildRecordIdMode|[`BuildRecordIdMode`](../ThinkGeo.Core/ThinkGeo.Core.BuildRecordIdMode.md)|N/A|
...
|---|---|---|
|tabPathFilename|`String`|N/A|
|databaseColumns|IEnumerable<[`TabDbfColumn`](../ThinkGeo.Core/ThinkGeo.Core.TabDbfColumn.md)>|N/A|
...
|Type|Description|
|---|---|
|[`TABProjInfo`](../ThinkGeo.Core/ThinkGeo.Core.TABProjInfo.md)|N/A|
...
|Type|Description|
|---|---|
|Dictionary<[`Feature`](../ThinkGeo.Core/ThinkGeo.Core.Feature.md),IEnumerable<[`Style`](../ThinkGeo.Core/ThinkGeo.Core.Style.md)>>|N/A|
...
|Name|Type|Description|
|---|---|---|
|proj|[`TABProjInfo`](../ThinkGeo.Core/ThinkGeo.Core.TABProjInfo.md)|N/A|
