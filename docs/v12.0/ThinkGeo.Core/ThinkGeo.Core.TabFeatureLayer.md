...
|Name|
|---|
|[`TabFeatureLayer()`](#tabfeaturelayer)|
|[`TabFeatureLayer(String)`](#tabfeaturelayerstring)|
|[`TabFeatureLayer(String,FileAccess)`](#tabfeaturelayerstringfileaccess)|
...
|[`StylingType`](#stylingtype)|[`TabStylingType`](../ThinkGeo.Core/ThinkGeo.Core.TabStylingType.md)|N/A|
...
|[`GetShapeTypeFromWellKnownBinary(Byte[],Int32)`](#getshapetypefromwellknownbinarybyte[]int32)|
...
[`TabStylingType`](../ThinkGeo.Core/ThinkGeo.Core.TabStylingType.md)
...
---
#### `GetShapeTypeFromWellKnownBinary(Byte[],Int32)`
...
|Type|Description|
|---|---|
|[`WkbShapeType`](../ThinkGeo.Core/ThinkGeo.Core.WkbShapeType.md)|N/A|
