...
|Name|
|---|
|[`InMemoryGridIsoLineLayer()`](#inmemorygridisolinelayer)|
|[`InMemoryGridIsoLineLayer(GridCell[,])`](#inmemorygridisolinelayergridcell[])|
|[`InMemoryGridIsoLineLayer(GridCell[,],Double)`](#inmemorygridisolinelayergridcell[]double)|
|[`InMemoryGridIsoLineLayer(GridCell[,],IEnumerable<Double>)`](#inmemorygridisolinelayergridcell[]ienumerable<double>)|
|[`InMemoryGridIsoLineLayer(GridCell[,],IEnumerable<Double>,Double)`](#inmemorygridisolinelayergridcell[]ienumerable<double>double)|
|[`InMemoryGridIsoLineLayer(GridCell[,],IEnumerable<Double>,Double,Double)`](#inmemorygridisolinelayergridcell[]ienumerable<double>doubledouble)|
|[`InMemoryGridIsoLineLayer(GridCell[,],IEnumerable<Double>,Double,Double,Double)`](#inmemorygridisolinelayergridcell[]ienumerable<double>doubledoubledouble)|
|[`InMemoryGridIsoLineLayer(GridCell[,],IEnumerable<Double>,Double,Double,Double,IsoLineType)`](#inmemorygridisolinelayergridcell[]ienumerable<double>doubledoubledoubleisolinetype)|
...
|[`GetIsoLineFeatures()`](#getisolinefeatures)|
|[`GetType()`](#gettype)|
|[`Open()`](#open)|
