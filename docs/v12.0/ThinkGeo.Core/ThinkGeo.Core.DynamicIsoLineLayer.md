...
|[`DynamicIsoLineLayer(IDictionary<PointShape,Double>)`](#dynamicisolinelayeridictionary<pointshapedouble>)|
|[`DynamicIsoLineLayer(IDictionary<PointShape,Double>,IEnumerable<Double>)`](#dynamicisolinelayeridictionary<pointshapedouble>ienumerable<double>)|
|[`DynamicIsoLineLayer(IDictionary<PointShape,Double>,IEnumerable<Double>,GridInterpolationModel)`](#dynamicisolinelayeridictionary<pointshapedouble>ienumerable<double>gridinterpolationmodel)|
|[`DynamicIsoLineLayer(IDictionary<PointShape,Double>,IEnumerable<Double>,GridInterpolationModel,IsoLineType)`](#dynamicisolinelayeridictionary<pointshapedouble>ienumerable<double>gridinterpolationmodelisolinetype)|
...
|[`CellHeightInPixel`](#cellheightinpixel)|`Int32`|N/A|
|[`CellWidthInPixel`](#cellwidthinpixel)|`Int32`|N/A|
...
|[`DataPoints`](#datapoints)|Dictionary<[`PointShape`](../ThinkGeo.Core/ThinkGeo.Core.PointShape.md),`Double`>|N/A|
...
|[`DynamicGridInterpolationModel`](#dynamicgridinterpolationmodel)|[`GridInterpolationModel`](../ThinkGeo.Core/ThinkGeo.Core.GridInterpolationModel.md)|This property represents the interpolation model used to generate IsoLines|
...
|[`IsoLineLevels`](#isolinelevels)|Collection<`Double`>|N/A|
|[`IsoLineType`](#isolinetype)|[`IsoLineType`](../ThinkGeo.Core/ThinkGeo.Core.IsoLineType.md)|N/A|
...
|[`NoDataValue`](#nodatavalue)|`Double`|N/A|
...
|[`GetIsoLineFeatures(RectangleShape,Double,GeographyUnit)`](#getisolinefeaturesrectangleshapedoublegeographyunit)|
|[`GetType()`](#gettype)|
|[`Open()`](#open)|
...
|[`GetFeaturesForDrawingCore(GeoCanvas,Collection<SimpleCandidate>)`](#getfeaturesfordrawingcoregeocanvascollection<simplecandidate>)|
...
[`IsoLineType`](../ThinkGeo.Core/ThinkGeo.Core.IsoLineType.md)
