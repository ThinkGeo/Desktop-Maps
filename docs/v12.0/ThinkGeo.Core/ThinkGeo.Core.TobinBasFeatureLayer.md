...
|Name|
|---|
|[`TobinBasFeatureLayer(String)`](#tobinbasfeaturelayerstring)|
...
|---|---|---|
|[`AnnotationTextStylingType`](#annotationtextstylingtype)|[`BasAnnotationTextStylingType`](../ThinkGeo.Core/ThinkGeo.Core.BasAnnotationTextStylingType.md)|N/A|
...
|[`MinAnnotationFontSize`](#minannotationfontsize)|`Int32`|N/A|
...
|[`TobinBasFilePathName`](#tobinbasfilepathname)|`String`|N/A|
...
[`BasAnnotationTextStylingType`](../ThinkGeo.Core/ThinkGeo.Core.BasAnnotationTextStylingType.md)
