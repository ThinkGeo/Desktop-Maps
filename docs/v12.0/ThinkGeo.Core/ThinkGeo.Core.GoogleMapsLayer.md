...
|[`GoogleMapsLayer(String,String)`](#googlemapslayerstringstring)|
|[`GoogleMapsLayer(String,String,IWebProxy)`](#googlemapslayerstringstringiwebproxy)|
...
|[`MapType`](#maptype)|[`GoogleMapsMapType`](../ThinkGeo.Core/ThinkGeo.Core.GoogleMapsMapType.md)|Gets or sets a value represents the map type of the GoogleMaps.|
...
|[`TimeoutInSeconds`](#timeoutinseconds)|`Int32`|Gets or sets a value represents the request timeout from the GoogleMaps server.|
