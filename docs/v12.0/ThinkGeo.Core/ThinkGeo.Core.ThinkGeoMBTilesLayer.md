...
|Name|
|---|
|[`ThinkGeoMBTilesLayer()`](#thinkgeombtileslayer)|
|[`ThinkGeoMBTilesLayer(String)`](#thinkgeombtileslayerstring)|
|[`ThinkGeoMBTilesLayer(String,Uri)`](#thinkgeombtileslayerstringuri)|
...
|Name|
|---|
|[`AddTile(VectorTile)`](#addtilevectortile)|
|[`BeginTransaction()`](#begintransaction)|
|[`CloneDeep()`](#clonedeep)|
|[`Close()`](#close)|
|[`CommitTransaction(TransactionBuffer)`](#committransactiontransactionbuffer)|
|[`CreateDatabase(String,Boolean)`](#createdatabasestringboolean)|
|[`DeleteTile(VectorTile)`](#deletetilevectortile)|
|[`Draw(GeoCanvas,Collection<SimpleCandidate>)`](#drawgeocanvascollection<simplecandidate>)|
|[`DrawGeometry(GeoCanvas,Collection<SimpleCandidate>)`](#drawgeometrygeocanvascollection<simplecandidate>)|
...
|[`GetTile(Int64,Int64,Int64)`](#gettileint64int64int64)|
|[`GetType()`](#gettype)|
|[`GetVectorTilesForDrawing(RectangleShape,Double)`](#getvectortilesfordrawingrectangleshapedouble)|
|[`Open()`](#open)|
...
|[`ToString()`](#tostring)|
|[`UpdateTile(VectorTile)`](#updatetilevectortile)|
...
|---|---|---|
|vectorTile|[`VectorTile`](../ThinkGeo.Core/ThinkGeo.Core.VectorTile.md)|N/A|
...
---
#### `CommitTransaction(TransactionBuffer)`
...
|Name|Type|Description|
|---|---|---|
|mbTilesPath|`String`|N/A|
|isOverwrite|`Boolean`|N/A|
...
---
#### `DrawGeometry(GeoCanvas,Collection<SimpleCandidate>)`
...
|Type|Description|
|---|---|
|[`VectorTile`](../ThinkGeo.Core/ThinkGeo.Core.VectorTile.md)|N/A|
...
---
#### `GetVectorTilesForDrawing(RectangleShape,Double)`
...
|Type|Description|
|---|---|
|Collection<[`VectorTile`](../ThinkGeo.Core/ThinkGeo.Core.VectorTile.md)>|N/A|
