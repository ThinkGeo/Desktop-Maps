...
|[`BackgroundLayer(GeoBrush)`](#backgroundlayergeobrush)|
...
|[`BackgroundBrush`](#backgroundbrush)|[`GeoBrush`](../ThinkGeo.Core/ThinkGeo.Core.GeoBrush.md)|This property gets and sets the brush for this background layer.|
...
|[`ThreadSafe`](#threadsafe)|[`ThreadSafetyLevel`](../ThinkGeo.Core/ThinkGeo.Core.ThreadSafetyLevel.md)|Gets the thread safe.|
...
|labelsInAllLayers|Collection<[`SimpleCandidate`](../ThinkGeo.Core/ThinkGeo.Core.SimpleCandidate.md)>|This parameter is not used for BackgroundLayers.|
