...
|Name|
|---|
|[`InMemoryGridFeatureLayer()`](#inmemorygridfeaturelayer)|
|[`InMemoryGridFeatureLayer(GridCell[,])`](#inmemorygridfeaturelayergridcell[])|
...
|[`ColumnCount`](#columncount)|`Int32`|Gets the column number from the grid.|
...
|[`RowCount`](#rowcount)|`Int32`|Gets the row number from the grid.|
