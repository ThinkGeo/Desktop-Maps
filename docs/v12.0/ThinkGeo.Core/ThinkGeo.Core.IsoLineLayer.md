...
+ `Object`
  + [`Layer`](../ThinkGeo.Core/ThinkGeo.Core.Layer.md)
    + **`IsoLineLayer`**
      + [`DynamicIsoLineLayer`](../ThinkGeo.Core/ThinkGeo.Core.DynamicIsoLineLayer.md)
      + [`GridIsoLineLayer`](../ThinkGeo.Core/ThinkGeo.Core.GridIsoLineLayer.md)
      + [`InMemoryGridIsoLineLayer`](../ThinkGeo.Core/ThinkGeo.Core.InMemoryGridIsoLineLayer.md)
...
|[`IsoLineLayer(IEnumerable<Double>)`](#isolinelayerienumerable<double>)|
|[`IsoLineLayer(IEnumerable<Double>,Double,Double)`](#isolinelayerienumerable<double>doubledouble)|
|[`IsoLineLayer(IEnumerable<Double>,Double,Double,IsoLineType)`](#isolinelayerienumerable<double>doubledoubleisolinetype)|
...
|[`GetIsoFeatures(GridCell[,],IEnumerable<Double>,String,IsoLineType)`](#getisofeaturesgridcell[]ienumerable<double>stringisolinetype)|
|[`GetIsoFeatures(GridCell[,],IEnumerable<Double>,String,IsoLineType,Double)`](#getisofeaturesgridcell[]ienumerable<double>stringisolinetypedouble)|
|[`GetIsoFeatures(GridFeatureSource,IEnumerable<Double>,String,IsoLineType)`](#getisofeaturesgridfeaturesourceienumerable<double>stringisolinetype)|
|[`GetIsoLineLevels(GridCell[,],Int32)`](#getisolinelevelsgridcell[]int32)|
|[`GetIsoLineLevels(IEnumerable<Double>,Int32)`](#getisolinelevelsienumerable<double>int32)|
|[`GetIsoLineLevels(Dictionary<PointShape,Double>,Int32)`](#getisolinelevelsdictionary<pointshapedouble>int32)|
|[`GetType()`](#gettype)|
|[`Open()`](#open)|
...
|Name|Type|Description|
|---|---|---|
|isoLineLevels|IEnumerable<`Double`>|N/A|
...
|---|---|---|
|isoLineLevels|IEnumerable<`Double`>|N/A|
|lowerScale|`Double`|N/A|
|upperScale|`Double`|N/A|
...
|lowerScale|`Double`|N/A|
|upperScale|`Double`|N/A|
|isoLineType|[`IsoLineType`](../ThinkGeo.Core/ThinkGeo.Core.IsoLineType.md)|N/A|
...
|isoLineLevels|IEnumerable<`Double`>|N/A|
|dataValueColumnName|`String`|N/A|
|isoLineType|[`IsoLineType`](../ThinkGeo.Core/ThinkGeo.Core.IsoLineType.md)|N/A|
...
|Name|Type|Description|
|---|---|---|
|gridFeatureSource|[`GridFeatureSource`](../ThinkGeo.Core/ThinkGeo.Core.GridFeatureSource.md)|N/A|
|isoLineLevels|IEnumerable<`Double`>|N/A|
|dataValueColumnName|`String`|N/A|
|isoLineType|[`IsoLineType`](../ThinkGeo.Core/ThinkGeo.Core.IsoLineType.md)|N/A|
...
|Name|Type|Description|
|---|---|---|
|dataValues|IEnumerable<`Double`>|N/A|
|isoLineLevelCount|`Int32`|N/A|
...
|Name|Type|Description|
|---|---|---|
|dataPoints|Dictionary<[`PointShape`](../ThinkGeo.Core/ThinkGeo.Core.PointShape.md),`Double`>|N/A|
|isoLineLevelCount|`Int32`|N/A|
