...
|[`MapShapes`](#mapshapes)|Dictionary<`String`,[`MapShape`](../ThinkGeo.Core/ThinkGeo.Core.MapShape.md)>|Get all the map shapes with the keys.|
...
Dictionary<`String`,[`MapShape`](../ThinkGeo.Core/ThinkGeo.Core.MapShape.md)>
