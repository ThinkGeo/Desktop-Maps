...
|Name|
|---|
|[`GradientStyle(String,Double,GeoColor,Double,GeoColor)`](#gradientstylestringdoublegeocolordoublegeocolor)|
|[`GradientStyle(String,Double,GeoColor,Double,GeoColor,Double,GeoColor)`](#gradientstylestringdoublegeocolordoublegeocolordoublegeocolor)|
...
|---|---|---|
|[`ColumnName`](#columnname)|`String`|This property gets and sets the column name used in the style.|
|[`Filters`](#filters)|Collection<`String`>|N/A|
|[`IsActive`](#isactive)|`Boolean`|N/A|
|[`LowerColor`](#lowercolor)|[`GeoColor`](../ThinkGeo.Core/ThinkGeo.Core.GeoColor.md)|This property gets and sets the solid brush that is used for the style's lower value.|
|[`LowerValue`](#lowervalue)|`Double`|This property gets and sets the lower value used in the style.|
|[`Name`](#name)|`String`|N/A|
|[`NoDataColor`](#nodatacolor)|[`GeoColor`](../ThinkGeo.Core/ThinkGeo.Core.GeoColor.md)|This property gets and sets the solid brush that is used for the style's NoDataValue.|
|[`NoDataValue`](#nodatavalue)|`Double`|This property gets and sets the no data value used in the style.|
|[`RequiredColumnNames`](#requiredcolumnnames)|Collection<`String`>|N/A|
|[`UpperColor`](#uppercolor)|[`GeoColor`](../ThinkGeo.Core/ThinkGeo.Core.GeoColor.md)|This property gets and sets the solid brush that is used for the style's upper value.|
|[`UpperValue`](#uppervalue)|`Double`|This property gets and sets the upper value used in the style.|
