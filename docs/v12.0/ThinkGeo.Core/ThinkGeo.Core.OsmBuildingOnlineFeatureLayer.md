...
|Name|
|---|
|[`OsmBuildingOnlineFeatureLayer()`](#osmbuildingonlinefeaturelayer)|
...
|[`TileCache`](#tilecache)|[`FileVectorTileCache`](../ThinkGeo.Core/ThinkGeo.Core.FileVectorTileCache.md)|Gets or sets the tileView cache.|
