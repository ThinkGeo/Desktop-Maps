...
|[`SqliteFeatureSource(String,String,String,String)`](#sqlitefeaturesourcestringstringstringstring)|
|[`SqliteFeatureSource(SqliteConnection,String,String,String)`](#sqlitefeaturesourcesqliteconnectionstringstringstring)|
|[`SqliteFeatureSource(SqliteConnection,String)`](#sqlitefeaturesourcesqliteconnectionstring)|
|[`SqliteFeatureSource(String,String)`](#sqlitefeaturesourcestringstring)|
...
|---|---|---|
|[`AlternateGeometryIndexTableName`](#alternategeometryindextablename)|`String`|N/A|
|[`CanExecuteSqlQuery`](#canexecutesqlquery)|`Boolean`|N/A|
|[`CanModifyColumnStructure`](#canmodifycolumnstructure)|`Boolean`|N/A|
|[`CommandTimeout`](#commandtimeout)|`Int32`|N/A|
|[`ConnectionString`](#connectionstring)|`String`|N/A|
|[`DrawnFeatureCount`](#drawnfeaturecount)|`Int32`|N/A|
|[`FeatureIdColumn`](#featureidcolumn)|`String`|N/A|
|[`FeatureIdsToExclude`](#featureidstoexclude)|Collection<`String`>|N/A|
|[`FetchTime`](#fetchtime)|`Double`|N/A|
|[`GeoCache`](#geocache)|[`FeatureCache`](../ThinkGeo.Core/ThinkGeo.Core.FeatureCache.md)|N/A|
|[`GeometryColumnName`](#geometrycolumnname)|`String`|N/A|
|[`Id`](#id)|`String`|N/A|
...
|[`CreateDatabase(String)`](#createdatabasestring)|
|[`CreateSpatialIndex(SqliteConnection,String,String,Int32)`](#createspatialindexsqliteconnectionstringstringint32)|
|[`CreateTable(SqliteConnection,String,IEnumerable<SqliteColumn>,GeographyUnit)`](#createtablesqliteconnectionstringienumerable<sqlitecolumn>geographyunit)|
|[`CreateTable(String,String,IEnumerable<SqliteColumn>,GeographyUnit)`](#createtablestringstringienumerable<sqlitecolumn>geographyunit)|
|[`CreateView(SqliteConnection,String,String,String,GeographyUnit,String)`](#createviewsqliteconnectionstringstringstringgeographyunitstring)|
|[`CreateView(SqliteConnection,String,String,String,GeographyUnit)`](#createviewsqliteconnectionstringstringstringgeographyunit)|
|[`CreateView(String,String,String,String,GeographyUnit)`](#createviewstringstringstringstringgeographyunit)|
...
|[`GetColumnNames(String,String)`](#getcolumnnamesstringstring)|
...
|[`GetTableNames(String)`](#gettablenamesstring)|
|[`GetType()`](#gettype)|
|[`Open()`](#open)|
...
|[`OnExecutingSqlStatement(ExecutingSqlStatementSqliteFeatureSourceEventArgs)`](#onexecutingsqlstatementexecutingsqlstatementsqlitefeaturesourceeventargs)|
...
|---|---|---|
|[`ExecutingSqlStatement`](#executingsqlstatement)|[`ExecutingSqlStatementSqliteFeatureSourceEventArgs`](../ThinkGeo.Core/ThinkGeo.Core.ExecutingSqlStatementSqliteFeatureSourceEventArgs.md)|N/A|
...
|Name|Type|Description|
|---|---|---|
|SqliteConnection|`SqliteConnection`|N/A|
|tableName|`String`|N/A|
|geometryColumnName|`String`|N/A|
|srid|`Int32`|N/A|
...
|Name|Type|Description|
|---|---|---|
|connection|`SqliteConnection`|N/A|
|tableName|`String`|Name of the new table|
|nonGeometryColumns|IEnumerable<[`SqliteColumn`](../ThinkGeo.Core/ThinkGeo.Core.SqliteColumn.md)>|nongeometry related columns to include in the new table|
|unit|[`GeographyUnit`](../ThinkGeo.Core/ThinkGeo.Core.GeographyUnit.md)|Unit used for projection|
...
|Name|Type|Description|
|---|---|---|
|connectionString|`String`|Connection string for the database to create the table in|
|tableName|`String`|Name of the new table|
|nonGeometryColumns|IEnumerable<[`SqliteColumn`](../ThinkGeo.Core/ThinkGeo.Core.SqliteColumn.md)>|nongeometry related columns to include in the new table|
|unit|[`GeographyUnit`](../ThinkGeo.Core/ThinkGeo.Core.GeographyUnit.md)|Unit used for projection|
...
|createViewSql|`String`|Sql statement to use when creating the view|
|featureIdColumn|`String`|The column to use as the feature Id|
|unit|[`GeographyUnit`](../ThinkGeo.Core/ThinkGeo.Core.GeographyUnit.md)|Unit used for projection|
|geometryColumnName|`String`|N/A|
...
|connection|`SqliteConnection`|N/A|
|viewName|`String`|N/A|
|createViewSql|`String`|N/A|
|featureIdColumn|`String`|N/A|
...
|Name|Type|Description|
|---|---|---|
|e|[`ExecutingSqlStatementSqliteFeatureSourceEventArgs`](../ThinkGeo.Core/ThinkGeo.Core.ExecutingSqlStatementSqliteFeatureSourceEventArgs.md)|N/A|
...
[`ExecutingSqlStatementSqliteFeatureSourceEventArgs`](../ThinkGeo.Core/ThinkGeo.Core.ExecutingSqlStatementSqliteFeatureSourceEventArgs.md)
