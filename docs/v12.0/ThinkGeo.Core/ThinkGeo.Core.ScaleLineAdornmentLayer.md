...
|Name|
|---|
|[`ScaleLineAdornmentLayer()`](#scalelineadornmentlayer)|
|[`ScaleLineAdornmentLayer(ScreenPointF)`](#scalelineadornmentlayerscreenpointf)|
|[`ScaleLineAdornmentLayer(AdornmentLocation)`](#scalelineadornmentlayeradornmentlocation)|
...
|[`Pen`](#pen)|[`GeoPen`](../ThinkGeo.Core/ThinkGeo.Core.GeoPen.md)|N/A|
...
|[`UnitSystem`](#unitsystem)|[`ScaleLineUnitSystem`](../ThinkGeo.Core/ThinkGeo.Core.ScaleLineUnitSystem.md)|Gets or sets the UnitSystem to be used for the ScaleLine.|
...
[`ScaleLineUnitSystem`](../ThinkGeo.Core/ThinkGeo.Core.ScaleLineUnitSystem.md)
