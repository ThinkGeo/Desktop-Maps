...
|Name|
|---|
|[`MultipleShapeFileFeatureSource()`](#multipleshapefilefeaturesource)|
|[`MultipleShapeFileFeatureSource(String)`](#multipleshapefilefeaturesourcestring)|
|[`MultipleShapeFileFeatureSource(String,String)`](#multipleshapefilefeaturesourcestringstring)|
|[`MultipleShapeFileFeatureSource(IEnumerable<String>)`](#multipleshapefilefeaturesourceienumerable<string>)|
|[`MultipleShapeFileFeatureSource(IEnumerable<String>,IEnumerable<String>)`](#multipleshapefilefeaturesourceienumerable<string>ienumerable<string>)|
...
|[`IndexFilePattern`](#indexfilepattern)|`String`|This parameter gets and sets the index file pattern.|
...
|[`MultipleShapeFilePattern`](#multipleshapefilepattern)|`String`|This parameter gets and sets the shape file pattern.|
...
|Name|Type|Description|
|---|---|---|
|multipleShapeFilePattern|`String`|This parameter is the shape file name pattern that you want to build an index for.|
...
|indexFilename|`String`|This parameter specifies the index file name.|
...
|Type|Description|
|---|---|
|Collection<`String`>|This method gets all the index's path and filenames are using in this class based on the pass in MultipleIndexFilePattern.|
...
|Type|Description|
|---|---|
|Collection<`String`>|This method gets all the shape's path and filenames are using in this class based on the pass in MultipleShapeFilePattern.|
