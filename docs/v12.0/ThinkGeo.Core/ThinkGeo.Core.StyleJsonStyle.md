...
|Name|
|---|
|[`StyleJsonStyle()`](#stylejsonstyle)|
|[`StyleJsonStyle(String)`](#stylejsonstylestring)|
...
|[`StyleJsonItems`](#stylejsonitems)|Collection<[`StyleJsonItem`](../ThinkGeo.Core/ThinkGeo.Core.StyleJsonItem.md)>|N/A|
|[`ZIndexColumn`](#zindexcolumn)|`String`|N/A|
...
Collection<[`StyleJsonItem`](../ThinkGeo.Core/ThinkGeo.Core.StyleJsonItem.md)>
